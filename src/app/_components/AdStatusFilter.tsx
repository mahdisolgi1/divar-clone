...
const AdStatusFilter: React.FC<AdStatusFilterProps> = ({
  ...
  return (
    <div className="w-full border-b z-40 cursor-pointer border-[#dbdbe4]">
      <div
      ...
      >
        ...
        <span className="text-xs">وضعیت آگهی</span>
        <MdKeyboardArrowDown
        ...
        <div className=" pb-4 flex flex-col gap-4">
          <div className="flex flex-row-reverse justify-between items-center">
            ...
            <label className="relative inline-flex cursor-pointer items-center">
              ...
              <div className="w-12 h-6 bg-black-medium-200 rounded-full peer-checked:bg-brand transition-colors duration-300 relative">
                <div
